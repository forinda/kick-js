...
- feat(vite): __KICKJS_DEVTOOLS__ build-time flag for devtools tree-shaking (M2.E) ([33cbee0](https://github.com/forinda/kick-js/commit/33cbee0df3bf6c4d9d17744031f77b6f2312548f)) — [@forinda](https://github.com/forinda)
...
- feat(db): \$extends({ model }) per-table method extension (M2.F-T17, v1) ([10a3c07](https://github.com/forinda/kick-js/commit/10a3c070edf64765c674d7881a5f54aa2982c60d)) — [@forinda](https://github.com/forinda)
- feat(db): pgEnum snapshot + diff + emit pipeline — CREATE TYPE flows through migrations ([2e6575b](https://github.com/forinda/kick-js/commit/2e6575b09ca090e7e6790cebcdf5d087da8cb86d)) — [@forinda](https://github.com/forinda)
- feat(db): wire CustomColumnBuilder.fromDriver via Kysely plugin (T16 follow-up) ([80e758e](https://github.com/forinda/kick-js/commit/80e758edaf267f3d7b97eb9eeddc9163af2e427b)) — [@forinda](https://github.com/forinda)
- feat(db): wire query / queryError / slowQuery emission via Kysely log (M2.F-T19) ([401e0f5](https://github.com/forinda/kick-js/commit/401e0f5c1341716a980b696dbcb93fac5273a518)) — [@forinda](https://github.com/forinda)
- feat(db): pgEnum() — typed PostgreSQL ENUM column builder ([e84f073](https://github.com/forinda/kick-js/commit/e84f0738b34ceef62c57097004f9e21c5ea9b2ec)) — [@forinda](https://github.com/forinda)
- feat(db): customType&lt;T&gt;() mapper for adopter-defined column types (M2.F-T16) ([aa481e9](https://github.com/forinda/kick-js/commit/aa481e91aa9f26f5488f4d3b3216295a6cc50695)) — [@forinda](https://github.com/forinda)
- feat(devtools): pagination defaults to 5/page with 5-step size choices ([ce789a5](https://github.com/forinda/kick-js/commit/ce789a5141d0c25dee34829f5fceb16bc448ffdb)) — [@forinda](https://github.com/forinda)
- feat(devtools): collapsible groups in Graph tab — header toggles + persists per-group ([c609404](https://github.com/forinda/kick-js/commit/c60940409dd12c398f4d66dc7471fbb5f301fbc7)) — [@forinda](https://github.com/forinda)
- feat(devtools): paginate Graph tab — per-group pager at 25/page ([c4ded45](https://github.com/forinda/kick-js/commit/c4ded452754143ec128479566a45fc5c6de41ebe)) — [@forinda](https://github.com/forinda)
- feat(kickjs): Application.getContributors() + devtools surfaces all source labels ([32c3571](https://github.com/forinda/kick-js/commit/32c35710b1f2598e2b72f34dd2874e7919eeeef4)) — [@forinda](https://github.com/forinda)
- feat(devtools): paginate Contributors + DI tokens tables in Topology tab ([35b5eaa](https://github.com/forinda/kick-js/commit/35b5eaa4472690ddaeaeb4fe7f23a783ce86faaa)) — [@forinda](https://github.com/forinda)
- feat(devtools): light/dark theme + gold/purple brand palette + contrast bumps ([6b3842f](https://github.com/forinda/kick-js/commit/6b3842f211984006cac60b8d7da3d28e52881acc)) — [@forinda](https://github.com/forinda)
- feat(devtools-kit): render-based tab contract alongside descriptor surface (M2.C-T12 additive) ([6ea9823](https://github.com/forinda/kick-js/commit/6ea98235d4f63fb1e7bc30994882110beb12e1e2)) — [@forinda](https://github.com/forinda)
- feat(cli): typegen.disable + kick typegen --list ([b678d08](https://github.com/forinda/kick-js/commit/b678d080c3fb571003e6c9d796e8dda176544a0a)) — [@forinda](https://github.com/forinda)
- feat(cli): carve kick/assets as a TypegenPlugin (M2.B-T8 partial) ([d4918f2](https://github.com/forinda/kick-js/commit/d4918f22286dc5aa4475990b15a5a1f1db795e65)) — [@forinda](https://github.com/forinda)
- feat(cli): plugin-typegen pipeline runs in kick dev + watchTypegen (M2.B-T10) ([e0bba54](https://github.com/forinda/kick-js/commit/e0bba540361b3638d5eb4b039970dbe61106bd37)) — [@forinda](https://github.com/forinda)
- feat(cli): roll generators + KickCliPluginContext into KickCliPlugin ([b536231](https://github.com/forinda/kick-js/commit/b536231401066918dc7f531a53dd3b1a3c081167)) — [@forinda](https://github.com/forinda)
- feat(cli): KickCliPlugin contract + dogfood every built-in as a plugin ([28bd4a8](https://github.com/forinda/kick-js/commit/28bd4a819d17d5ef8a792ff8c940493fb99c7890)) — [@forinda](https://github.com/forinda)
- feat(cli): kick/db TypegenPlugin emits KickDbRegister augmentation (M2.B-T9) ([2439061](https://github.com/forinda/kick-js/commit/2439061220ccc3870bf117f6c9f6d0b0cb58b39d)) — [@forinda](https://github.com/forinda)
- feat(cli): TypegenPlugin contract + runner with --check (M2.B-T7) ([649124d](https://github.com/forinda/kick-js/commit/649124ddc3793e9de919fe6fd53b310e82567434)) — [@forinda](https://github.com/forinda)
- feat(example): add self-referencing categories table to task-kickdb-api ([9b17e50](https://github.com/forinda/kick-js/commit/9b17e50aeddc336560537f2eb773eaf7973327ef)) — [@forinda](https://github.com/forinda)
- feat(db): self-referencing FKs via lazy thunk + ColumnRef + FkAction tightening ([e14ddd0](https://github.com/forinda/kick-js/commit/e14ddd07555f1adeb9ca0bb69e2fc8fcfe9a3dc1)) — [@forinda](https://github.com/forinda)
- feat(db): infer DB from schema in createDbClient + KickDbRegister augmentation (M2.A-T6) ([dc10197](https://github.com/forinda/kick-js/commit/dc101972487d55753cefe307c764a781a5194379)) — [@forinda](https://github.com/forinda)
- feat(db): Register interface augmentation for automatic KickDbClient typing (M2.A-T4, M2.A-T5) ([e9be025](https://github.com/forinda/kick-js/commit/e9be025dc59dadc45dd92de4d563fbcb282de802)) — [@forinda](https://github.com/forinda)
- feat(db): tighten SchemaToKysely with phantom inference + Generated wrapping (M2.A-T3, partial M2.A-T5) ([e7fa6d3](https://github.com/forinda/kick-js/commit/e7fa6d321e8a469beac25027f8758a756fd87a76)) — [@forinda](https://github.com/forinda)
- feat(db): phantom &lt;T, TNullable&gt; on ColumnBuilder + GeneratedBrand (M2.A-T1, M2.A-T2) ([8e63621](https://github.com/forinda/kick-js/commit/8e63621fb9fbf0c4d6d6f65b8a537c022b3fed4f)) — [@forinda](https://github.com/forinda)
- feat(db): add renderSchemaSource() + kick db introspect command (M1-S10) ([78fba58](https://github.com/forinda/kick-js/commit/78fba584565414fb044471da8dc66a2608c711a4)) — [@forinda](https://github.com/forinda)
- feat(cli): wire kick db migrate {latest,up,down,rollback,status} (M1-S5) ([90e5cb1](https://github.com/forinda/kick-js/commit/90e5cb17d2d031a300b4f20e9afdef3404eb8c8f)) — [@forinda](https://github.com/forinda)
- feat(db): KickDbClient over Kysely with events + transaction + savepoint (M1-S8) ([407b2e5](https://github.com/forinda/kick-js/commit/407b2e55292f4bd6c8d2a65a4e6e5e2c7755b5a1)) — [@forinda](https://github.com/forinda)
- feat(db-pg): accept any PgPoolLike — decouple from literal pg.Pool ([8b178c2](https://github.com/forinda/kick-js/commit/8b178c2213c401ce5c373e3c485c92fe527d6a43)) — [@forinda](https://github.com/forinda)
- feat(db-pg): bootstrap @forinda/kickjs-db-pg + pgAdapter (M1-S8 part 1) ([eb10de9](https://github.com/forinda/kick-js/commit/eb10de98c44e71b72e10a04e31983424b36f1c05)) — [@forinda](https://github.com/forinda)
- feat(db): export DB_PRIMARY/DB_REPLICA/DB_CLIENT DI tokens (M1-S9) ([fff18c1](https://github.com/forinda/kick-js/commit/fff18c163dc6a834a0d434d68eeaaf0df06f0f10)) — [@forinda](https://github.com/forinda)
- feat(db): drift detection via diff(live, expected) (M1-S6) ([5fa9f37](https://github.com/forinda/kick-js/commit/5fa9f37df50009b736d7236337fb09e74f59ac1e)) — [@forinda](https://github.com/forinda)
- feat(db): introspectPg() — SchemaSnapshot from a live PG database (M1-S6, M1-S10) ([3c79c9c](https://github.com/forinda/kick-js/commit/3c79c9c78d45a0a641452d330bf74b8c11bd27c3)) — [@forinda](https://github.com/forinda)
- feat(db): migrateStatus runner — applied/pending summary (M1-S5) ([f27d3b4](https://github.com/forinda/kick-js/commit/f27d3b43bc1980b2683e82f83da6737d44a750bf)) — [@forinda](https://github.com/forinda)
- feat(db): migrateRollback runner — reverse entire last batch (M1-S5) ([23ed6b2](https://github.com/forinda/kick-js/commit/23ed6b25b0cbe4bf1b316e6a4f914b25883edd41)) — [@forinda](https://github.com/forinda)
- feat(db): migrateDown runner — reverse most recent (M1-S5) ([9fd5ad0](https://github.com/forinda/kick-js/commit/9fd5ad008e04f77224ef5831457a62e3ed6415bf)) — [@forinda](https://github.com/forinda)
- feat(db): migrateUp runner — apply single next pending (M1-S5) ([1c7b4e8](https://github.com/forinda/kick-js/commit/1c7b4e89cec5a5a6923fc7e30106cd617f62db54)) — [@forinda](https://github.com/forinda)
- feat(db): migrateLatest runner — lock + batch + hash verify + reviewed enforcement (M1-S5) ([1bb6370](https://github.com/forinda/kick-js/commit/1bb6370129ecd86bb1581276e4f393fd56a97c70)) — [@forinda](https://github.com/forinda)
- feat(db): MemoryMigrationAdapter for unit tests (M1-S4) ([88ef411](https://github.com/forinda/kick-js/commit/88ef41158acc0a47723e1168879ce5b31db06eaf)) — [@forinda](https://github.com/forinda)
- feat(db): MigrationAdapter contract + per-dialect kick_migrations/lock DDL (M1-S4) ([0e6ea8e](https://github.com/forinda/kick-js/commit/0e6ea8e972e7f875083163062545bf7f6e5c6f23)) — [@forinda](https://github.com/forinda)
- feat(db): add \_journal.json with deterministic per-migration hashes (M1-S3) ([b655e3a](https://github.com/forinda/kick-js/commit/b655e3a8fc55d1fd01da9b61d1ef377bbaadbd1b)) — [@forinda](https://github.com/forinda)
- feat(db): add KickDbError + Migration\* error hierarchy (M1-S3..S6) ([ec4a940](https://github.com/forinda/kick-js/commit/ec4a9403a7193179c7989f8dbe7d2d534f106676)) — [@forinda](https://github.com/forinda)
- feat(db): add @forinda/kickjs-db/pg subpath with vector/citext/money/inet/cidr/xml/tsvector (M1-S1) ([735b8ec](https://github.com/forinda/kick-js/commit/735b8ecf4ab1d147df0d4d7842aaed6c59d8ebcf)) — [@forinda](https://github.com/forinda)
- feat(db): add json/jsonb/bytea + .array() modifier (M1-S1) ([56893cb](https://github.com/forinda/kick-js/commit/56893cbbf9de0a3f78ed163b02a7f88b03f9fa7d)) — [@forinda](https://github.com/forinda)
- feat(db): add char/timestamptz/date/time/interval/uuid column types (M1-S1) ([df7a56c](https://github.com/forinda/kick-js/commit/df7a56c75c2c548c6726681417c4cc4031bf421f)) — [@forinda](https://github.com/forinda)
- feat(db): add bigSerial/bigint/smallint/decimal/numeric/real/doublePrecision (M1-S1) ([fb3f363](https://github.com/forinda/kick-js/commit/fb3f3639f0383e8a26507ff18130e2058fb7ad79)) — [@forinda](https://github.com/forinda)
- feat(db): add --empty flag to kick db generate for seed/freeform migrations ([d0a5c53](https://github.com/forinda/kick-js/commit/d0a5c53a9e2bed6675b9b7489af58c819aba2169)) — [@forinda](https://github.com/forinda)
- feat(db): emit down.sql with REVIEWED + DRAFT markers; meta.previousId chain ([f7c0c5b](https://github.com/forinda/kick-js/commit/f7c0c5b767684f0f696f9a8d15fe77186c9bf63f)) — [@forinda](https://github.com/forinda)
- feat(cli): register kick db generate command (M0-S6) ([2bf768b](https://github.com/forinda/kick-js/commit/2bf768b38bb93b6c83a7db7a3d70c755d4861a2d)) — [@forinda](https://github.com/forinda)
- feat(db): add generate() — schema load → diff → emit → write (M0-S6) ([55cc445](https://github.com/forinda/kick-js/commit/55cc44535971e29875b9fd3cbc5a72d36fb9624e)) — [@forinda](https://github.com/forinda)
- feat(db): add resolveDbConfig() loading kick.config.ts (M0-S6) ([3cd9bfa](https://github.com/forinda/kick-js/commit/3cd9bfafd1a968c0fb6650cab1b33772ad0540db)) — [@forinda](https://github.com/forinda)
- feat(db): pg emitter — indexes, FKs, FK actions (M0-S4) ([6b47a11](https://github.com/forinda/kick-js/commit/6b47a11b06a7ebdbe929f5343b8388c44f546265)) — [@forinda](https://github.com/forinda)
- feat(db): pg emitter — ADD/DROP/ALTER/RENAME COLUMN (M0-S4) ([e278d9b](https://github.com/forinda/kick-js/commit/e278d9bc1caa241dc0511df24ebfb70c7585c0b1)) — [@forinda](https://github.com/forinda)
- feat(db): pg emitter — CREATE/DROP/RENAME TABLE (M0-S4) ([f41b63f](https://github.com/forinda/kick-js/commit/f41b63fe3320a3c81aeb57ad022d625e4a969d8d)) — [@forinda](https://github.com/forinda)
- feat(db): add quoteIdent + quoteLiteral helpers (M0-S4) ([e830944](https://github.com/forinda/kick-js/commit/e830944e5e53fb7b504dffbf53b33619e802cd9e)) — [@forinda](https://github.com/forinda)
- feat(db): diff engine — column rename heuristic (M0-S3) ([f52ea07](https://github.com/forinda/kick-js/commit/f52ea07c7b0794df497806e0b5b842f262e9d1d7)) — [@forinda](https://github.com/forinda)
- feat(db): diff engine — indexes & foreign keys (M0-S3) ([9ddc54d](https://github.com/forinda/kick-js/commit/9ddc54de306db9efbde92c6305bcc942bb6f950e)) — [@forinda](https://github.com/forinda)
- feat(db): diff engine — alter column (M0-S3) ([fd78be8](https://github.com/forinda/kick-js/commit/fd78be8217b606a3a26cc9e1c4bd0854d9700853)) — [@forinda](https://github.com/forinda)
- feat(db): diff engine — column add/drop (M0-S3) ([6daf5f4](https://github.com/forinda/kick-js/commit/6daf5f416d8c14fd5183592fec584cc8ded4f85b)) — [@forinda](https://github.com/forinda)
- feat(db): diff engine — table create/drop (M0-S3) ([a7fb887](https://github.com/forinda/kick-js/commit/a7fb887bee394f0d74550918a11aa0b54116dd72)) — [@forinda](https://github.com/forinda)
- feat(db): add ChangeSet IR types (M0-S3) ([6fae6c2](https://github.com/forinda/kick-js/commit/6fae6c2d66704f5efc9b38cfe19e3390a393ab8f)) — [@forinda](https://github.com/forinda)
- feat(db): add extractSnapshot() walking DSL → SchemaSnapshot (M0-S2) ([9a4fcd9](https://github.com/forinda/kick-js/commit/9a4fcd91e8b897d998a513993bf773bd58386f6a)) — [@forinda](https://github.com/forinda)
- feat(db): add relations() stub (M0-S2) ([0f0c939](https://github.com/forinda/kick-js/commit/0f0c939ed8c304aee9b91ab8792e4bdcb446cc3a)) — [@forinda](https://github.com/forinda)
- feat(db): add table() factory with index/unique/references (M0-S2) ([31984ed](https://github.com/forinda/kick-js/commit/31984ed1fc8b22621e621c5c60d561424106d094)) — [@forinda](https://github.com/forinda)
- feat(db): add varchar/text/boolean/timestamp column types (M0-S2) ([3a80d9a](https://github.com/forinda/kick-js/commit/3a80d9a9df05f9165733867fc6bdd71be68015d8)) — [@forinda](https://github.com/forinda)
- feat(db): add ColumnBuilder + serial/integer column types (M0-S2) ([323551f](https://github.com/forinda/kick-js/commit/323551ff3acd40abb1dafae029d6d024ce0a3f54)) — [@forinda](https://github.com/forinda)
- feat(db): add SchemaSnapshot IR with JSON roundtrip test (M0-S1) ([86b8bb5](https://github.com/forinda/kick-js/commit/86b8bb5ca93f5f5a2846f6d41c1cd61837376ef3)) — [@forinda](https://github.com/forinda)
- feat(db): bootstrap @forinda/kickjs-db package skeleton (M0-S1) ([5debbad](https://github.com/forinda/kick-js/commit/5debbad2de4e816de31c79a78e1cd449bf29a6db)) — [@forinda](https://github.com/forinda)

## Bug Fixes

- fix(db): rename .kysely → .qb in tests/docs + sidestep \$extends `this:` self-reference pitfall ([b6ca93d](https://github.com/forinda/kick-js/commit/b6ca93d9039e06100e7df29bc686395a1f2249dd)) — [@forinda](https://github.com/forinda)
- fix(db): pgEnum() variadic rest API + restore string keys in contributor test ([c058ddf](https://github.com/forinda/kick-js/commit/c058ddf7e55b09dc3be243293eabc852d77aacb2)) — [@forinda](https://github.com/forinda)
- fix(db): pgEnum() — `const TValues` so values narrow when passed via a variable ([546e578](https://github.com/forinda/kick-js/commit/546e57844c08c4e051ed387e21b1c547c91d04d7)) — [@forinda](https://github.com/forinda)
- fix(devtools): theme-flip the modal + memory/runtime sparklines + add legacy CSS-var aliases ([ee9362c](https://github.com/forinda/kick-js/commit/ee9362c4950c2a6f5e26e8c692ee02a2504122bc)) — [@forinda](https://github.com/forinda)
- fix(devtools): migrate tab utilities to semantic theme tokens — light mode now flips end-to-end ([407e4d3](https://github.com/forinda/kick-js/commit/407e4d3092701c7e6dc253a45c03648e5d5a4308)) — [@forinda](https://github.com/forinda)
- fix(devtools): polish card visuals — shadow + hover + larger metric values ([463e58c](https://github.com/forinda/kick-js/commit/463e58c0ebb0d03bdd3bbb9f11a6bb41c214b345)) — [@forinda](https://github.com/forinda)
- fix(devtools): switch theme overrides off light-dark() + soften dark palette + pre-paint script ([956d1fb](https://github.com/forinda/kick-js/commit/956d1fbb19d2bc815181da57a5a99862e653a570)) — [@forinda](https://github.com/forinda)
- fix(kickjs): Container emits 'resolved' events on every resolve path ([ca3ee78](https://github.com/forinda/kick-js/commit/ca3ee78a5dca421bfcdfdf8e06e2a4949261c71d)) — [@forinda](https://github.com/forinda)
- fix(kickjs): @Autowired property deps surface on registration.dependencies ([8362813](https://github.com/forinda/kick-js/commit/8362813f7dc6a0fa2fe08f442cb676bc83cdbf5d)) — [@forinda](https://github.com/forinda)
- fix(db): brand-based nullability + literal table names — preserve subclass through chain ([024d0c8](https://github.com/forinda/kick-js/commit/024d0c81d04d0af8d5113de9f167c39c9685c071)) — [@forinda](https://github.com/forinda)
- fix(kickjs): suppress dotenv 17 tip banner with quiet:true ([4e34cfd](https://github.com/forinda/kick-js/commit/4e34cfd196ba3e38cad4a313a7a4e8b71c46f26f)) — [@forinda](https://github.com/forinda)
- fix(db): emit CREATE TABLEs before any FK in initial diff ([342096d](https://github.com/forinda/kick-js/commit/342096d0e920753eedf417df0ed9bf67ddd16b1f)) — [@forinda](https://github.com/forinda)
- fix(cli): accept empty --packages for non-interactive scaffolding ([1f653c6](https://github.com/forinda/kick-js/commit/1f653c657ef9f19bf8a0536974150cd9a4005942)) — [@forinda](https://github.com/forinda)

## Documentation

- docs: register cli-plugins + db guides in VitePress sidebar ([d2f2727](https://github.com/forinda/kick-js/commit/d2f2727af2c5e37c6c65bc7410e8155909de14ba)) — [@forinda](https://github.com/forinda)
- docs: M2 release notes (M2.G-T22) ([7b7be21](https://github.com/forinda/kick-js/commit/7b7be21635eb1eb8cb6bdd0c20ed6fb6eac5e81d)) — [@forinda](https://github.com/forinda)
- docs(db): adopter guides for schema types + extensions (M2.G-T20 partial) ([c68b12e](https://github.com/forinda/kick-js/commit/c68b12e8d455fea7e816a9b9ddbc798537a75150)) — [@forinda](https://github.com/forinda)
- docs: typegen.disable + kick typegen --list ([4d8e22c](https://github.com/forinda/kick-js/commit/4d8e22c8cb4e7ec68d35fb59f8897ea74fd05cc7)) — [@forinda](https://github.com/forinda)
- docs: sync CLI plugin contract + soften folder-structure prescriptions ([fda219d](https://github.com/forinda/kick-js/commit/fda219dac85cd25e2038ad8c93c18d981285656f)) — [@forinda](https://github.com/forinda)
- docs: cli-plugins guide for KickCliPlugin contract ([bb17fce](https://github.com/forinda/kick-js/commit/bb17fce7dd95fce4bb2c7a00002511fa30a9922c)) — [@forinda](https://github.com/forinda)
- docs(db): M2 implementation plan ([0757880](https://github.com/forinda/kick-js/commit/07578807d7564a78dfc061b1aea5eddd39225751)) — [@forinda](https://github.com/forinda)
- docs(db): spec for platform-wide devtools / dev-server / typegen improvements ([a99cc4a](https://github.com/forinda/kick-js/commit/a99cc4ab868cbb3d379daab9be5b0f92c4b5c027)) — [@forinda](https://github.com/forinda)
- docs(db): spec for automatic schema type augmentation ([942a66f](https://github.com/forinda/kick-js/commit/942a66f830133598807502f115c3ce5ccfed4a2a)) — [@forinda](https://github.com/forinda)
- docs(db): add TanStack patterns research notes ([9e50191](https://github.com/forinda/kick-js/commit/9e501910736e086f562980ec39f012c8f1794c98)) — [@forinda](https://github.com/forinda)
- docs(db): expand M1 Tasks 14 and 19 to fully bite-sized steps ([6b51854](https://github.com/forinda/kick-js/commit/6b5185481a1d7dfdedbd36682f663fe1b10d75b1)) — [@forinda](https://github.com/forinda)
- docs(db): add M1 (Walking Skeleton) implementation plan ([80a6668](https://github.com/forinda/kick-js/commit/80a666860057a31733847223f6c44c4c91826776)) — [@forinda](https://github.com/forinda)
- docs(db): add design spec, story backlog, and M0 implementation plan ([55d12de](https://github.com/forinda/kick-js/commit/55d12dea0aac94ae4ed7279035c9df7b049b6cc8)) — [@forinda](https://github.com/forinda)

## Tests

- test(db-pg): kickDbAdapter migrationsOnBoot {fail-if-pending,apply,ignore} (M1-S7) ([80cdce7](https://github.com/forinda/kick-js/commit/80cdce767c77db278088b6813927c1343e3274dd)) — [@forinda](https://github.com/forinda)
- test(db): generate() end-to-end (M0-S6) ([9c2efc3](https://github.com/forinda/kick-js/commit/9c2efc3c928d1623c392726c0af1e7965ac109d3)) — [@forinda](https://github.com/forinda)
- test(db): full-pipeline integration test on real PG (M0-S5) ([381b8ef](https://github.com/forinda/kick-js/commit/381b8ef6c1412f9a9e8bb4f093e3e2dcbd569fce)) — [@forinda](https://github.com/forinda)

## Maintenance

- refactor(db): rename adopter-facing surface to drop Kysely-named exports ([3951cf9](https://github.com/forinda/kick-js/commit/3951cf9424f47151dab30ba007d134409c125fd1)) — [@forinda](https://github.com/forinda)
- chore(db): pin kysely as direct dep + ship pgDialect() so adopters never import from 'kysely' ([97e3a4a](https://github.com/forinda/kick-js/commit/97e3a4a201f2118992682eff19871ca9add2f802)) — [@forinda](https://github.com/forinda)
- chore(db): unprivate + adopter-facing READMEs for v5.1.0 publish ([26b20b7](https://github.com/forinda/kick-js/commit/26b20b75abbad7c4cbb1bb5210f1c66352c93939)) — [@forinda](https://github.com/forinda)
- example(task-kickdb-api): full 17-table port of task-prisma-api (M2.G-T21) ([cddaf9b](https://github.com/forinda/kick-js/commit/cddaf9b300b37506ffc6a0ba0ce12cc2538ee18e)) — [@forinda](https://github.com/forinda)
- example(task-kickdb-api): KickJS-native ORM end-to-end (M1-S10) ([0b5de4d](https://github.com/forinda/kick-js/commit/0b5de4d9935bb770981d5f06b8442f61c6e0fa62)) — [@forinda](https://github.com/forinda)
- chore(db): mark @forinda/kickjs-db as private ([4392798](https://github.com/forinda/kick-js/commit/43927985a4ca3b2383c806bccaf152cb671488c2)) — [@forinda](https://github.com/forinda)
- example(db-spike-api): smoke-test fixture for the M0 diff engine ([2582560](https://github.com/forinda/kick-js/commit/2582560eedb7fff4a8e9adbe8596ae4e53e5d19d)) — [@forinda](https://github.com/forinda)
...
**Full Changelog**: https://github.com/forinda/kick-js/compare/v5.0.2...v5.1.0
**Packages**: `@forinda/kickjs-ai`, `@forinda/kickjs-auth`, `@forinda/kickjs-cli`, `@forinda/kickjs-db`, `@forinda/kickjs-db-pg`, `@forinda/kickjs-devtools`, `@forinda/kickjs-devtools-kit`, `@forinda/kickjs-drizzle`, `@forinda/kickjs-kickjs`, `@forinda/kickjs-lint`, `@forinda/kickjs-mcp`, `@forinda/kickjs-prisma`, `@forinda/kickjs-queue`, `@forinda/kickjs-swagger`, `@forinda/kickjs-testing`, `@forinda/kickjs-vite`, `@forinda/kickjs-vscode-extension`, `@forinda/kickjs-ws`
...
- fix(container): invoke factory in REQUEST scope resolve path (#143) ([39974e2](https://github.com/forinda/kick-js/commit/39974e2fdfb00051792f4068ecb4b3efbca54949)) — [@forinda](https://github.com/forinda)

## Documentation

- docs: thin old docs ([152d81d](https://github.com/forinda/kick-js/commit/152d81db9b197c5a12f1f46978ac6afbc02962ec)) — [@forinda](https://github.com/forinda)
...
**Full Changelog**: https://github.com/forinda/kick-js/compare/v5.0.0...v5.0.1
**Packages**: `@forinda/kickjs-ai`, `@forinda/kickjs-auth`, `@forinda/kickjs-cli`, `@forinda/kickjs-devtools`, `@forinda/kickjs-devtools-kit`, `@forinda/kickjs-drizzle`, `@forinda/kickjs-kickjs`, `@forinda/kickjs-lint`, `@forinda/kickjs-mcp`, `@forinda/kickjs-prisma`, `@forinda/kickjs-queue`, `@forinda/kickjs-swagger`, `@forinda/kickjs-testing`, `@forinda/kickjs-vite`, `@forinda/kickjs-vscode-extension`, `@forinda/kickjs-ws`

# Release v5.0.0

## Breaking Changes

- feat!: remove otel/cron/mailer/multi-tenant/notifications for v5 ([71b6738](https://github.com/forinda/kick-js/commit/71b6738c4c1aa9414c63650d9996777644853fa0)) — [@forinda](https://github.com/forinda)
- feat!: remove @forinda/kickjs-graphql for v5 ([ae96e7e](https://github.com/forinda/kick-js/commit/ae96e7ec9d7c4e3f5a7f17a3855a4aaa96670072)) — [@forinda](https://github.com/forinda)
- refactor(prisma,drizzle)!: tenant adapters read getRequestValue('tenant') instead of importing kickjs-multi-tenant ([96ae13d](https://github.com/forinda/kick-js/commit/96ae13d752e905c0e6cd3323afb5e9e004e8406b)) — [@forinda](https://github.com/forinda)

## Maintenance

- chore(examples,packages,docs): migrate examples to BYO + scrub deprecated cross-refs + queue v5 sketch ([7137891](https://github.com/forinda/kick-js/commit/71378913151a0bc1c8c0469321fcef97d5159e6a)) — [@forinda](https://github.com/forinda)
...
**Full Changelog**: https://github.com/forinda/kick-js/compare/v4.2.0...v5.0.0
**Packages**: `@forinda/kickjs-ai`, `@forinda/kickjs-auth`, `@forinda/kickjs-cli`, `@forinda/kickjs-devtools`, `@forinda/kickjs-devtools-kit`, `@forinda/kickjs-drizzle`, `@forinda/kickjs-kickjs`, `@forinda/kickjs-lint`, `@forinda/kickjs-mcp`, `@forinda/kickjs-prisma`, `@forinda/kickjs-queue`, `@forinda/kickjs-swagger`, `@forinda/kickjs-testing`, `@forinda/kickjs-vite`, `@forinda/kickjs-vscode-extension`, `@forinda/kickjs-ws`
...
- feat(kickjs): bootstrap({ processHooks }) + getRequestValue/getRequestStore ([93d09af](https://github.com/forinda/kick-js/commit/93d09af1b9b32ba75e97c9551c199af73edb0dbd)) — [@forinda](https://github.com/forinda)

## Bug Fixes

- fix(cli): defineAugmentation extractor preserves backtick strings + escapes ([96272bf](https://github.com/forinda/kick-js/commit/96272bf27f7db09a68c7eb0d5b871e358fb99a85)) — [@forinda](https://github.com/forinda)

## Documentation

- docs: BYO recipes for v5 deprecation cohort + lifecycle/context rewrites + comparison.md ([e6f9579](https://github.com/forinda/kick-js/commit/e6f957903e140c92773f9a44df07ca82393cd4c2)) — [@forinda](https://github.com/forinda)
- docs,cli: sweep adapter/plugin examples to defineAdapter/definePlugin + bulk-up generators ([00c3391](https://github.com/forinda/kick-js/commit/00c339152419d3d84e2e3edfa62e20361a9129d9)) — [@forinda](https://github.com/forinda)
- docs: drop @Controller('path') from examples + rewrite context-decorators guide ([67e18bd](https://github.com/forinda/kick-js/commit/67e18bd2b4faee4b5e8f2d62316c0abb4194814a)) — [@forinda](https://github.com/forinda)

## Maintenance

- chore(packages,cli): mark 6 wrappers deprecated for v5 cutover + drop GraphQL CLI surface ([745ee43](https://github.com/forinda/kick-js/commit/745ee433dd9272ed160f7ee371f3590eb3a202aa)) — [@forinda](https://github.com/forinda)
...
**Full Changelog**: https://github.com/forinda/kick-js/compare/v4.1.0...v4.2.0
...
- refactor(http)!: drop req.\_\_ctxMeta fallback — ctx.set throws outside ALS ([b5de45f](https://github.com/forinda/kick-js/commit/b5de45f6ca0b62f8b4156d1bd5355e46ab31b817)) — [@forinda](https://github.com/forinda)
...
- chore(examples): rename jira-_ example dirs to task-_ + update all references ([f2939ae](https://github.com/forinda/kick-js/commit/f2939ae9aa6a6cdd8cef0b39bef1df92c4742af0)) — [@forinda](https://github.com/forinda)
