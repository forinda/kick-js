...
async function seed() {
  ...
  const frontendTasks = await TaskModel.insertMany([
    ...
    },
    {
      ...
      status: 'in-progress',
      priority: 'high',
      assigneeIds: [bob._id, carol._id],
      reporterId: bob._id,
      labelIds: [featureLabel._id, urgentLabel._id],
      orderIndex: 1,
    },
    // ... more tasks
  ])
  ...
  await ChannelModel.insertMany([
    ...
    },
    {
      ...
      type: 'public',
      memberIds: [alice._id, bob._id, carol._id],
