...
<PmCommand exec="kick g module todos" />

`--pattern minimal` for just a controller + module, `-m` and `--repo` for placement and the repository stub. Full flag list: [Generators](./generators.md#kick-g-module).
:::
