...
2. [x] **Sub-path exports** — migrated `@forinda/kickjs` with 10 entry points. Vite's `build.lib.entry` object handles multiple entries with automatic chunk splitting.
