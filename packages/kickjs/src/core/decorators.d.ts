...
export declare const Get: (path?: string, validation?: RouteDefinition["validation"]) => MethodDecorator;
export declare const Post: (path?: string, validation?: RouteDefinition["validation"]) => MethodDecorator;
export declare const Put: (path?: string, validation?: RouteDefinition["validation"]) => MethodDecorator;
export declare const Delete: (path?: string, validation?: RouteDefinition["validation"]) => MethodDecorator;
export declare const Patch: (path?: string, validation?: RouteDefinition["validation"]) => MethodDecorator;
 ...
 */
export declare function normalizeApiQueryParamsConfig(config: ApiQueryParamsConfig | ColumnApiQueryParamsConfig): ApiQueryParamsConfig;
/**
 ...
 * ```
 */
export declare function ApiQueryParams(config: ApiQueryParamsConfig | ColumnApiQueryParamsConfig): MethodDecorator;
/**
 ...
 * ```
 */
export type MiddlewareHandler = (ctx: import('../http/context').RequestContext, next: () => void) => void | Promise<void>;
/** Attach middleware handlers to a class or method */
export declare function Middleware(...handlers: MiddlewareHandler[]): ClassDecorator & MethodDecorator;
/**
