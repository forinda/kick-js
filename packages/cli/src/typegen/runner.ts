...
/**
 * Prepended to every generated file. Exported because a plugin that caches its
 * own output has to know what the file it is vouching for actually looks like
 * on disk — see `typegen/builtin/client.ts`.
 */
export const BANNER_PREFIX = '/* AUTO-GENERATED by kick typegen — do not edit. Plugin: '
