...
- [#726](https://github.com/forinda/kick-js/pull/726) [`1d13fb1`](https://github.com/forinda/kick-js/commit/1d13fb1006c422ab7ac56f716c57a0847c3a0de1) Thanks [@forinda](https://github.com/forinda)! - `kick new --template fullstack` sets `server.strictPort: true` in `server/vite.config.ts`. `web/`'s dev proxy targets the API port, so `kick dev` now fails when that port is taken instead of moving to another one the proxy can't reach.
  ...
  - pnpm 10+: `pnpm-workspace.yaml`, in both formats — `allowBuilds` (pnpm 10.26+ and 11) and `onlyBuiltDependencies` / `ignoredBuiltDependencies` (earlier pnpm 10). Each version ignores the one it does not read. Standalone `rest`/`minimal` projects now get it, not only fullstack. Without it pnpm 11 failed the non-interactive install and every `pnpm exec` / script with `ERR_PNPM_IGNORED_BUILDS`.
...
- Updated dependencies [[`6032d65`](https://github.com/forinda/kick-js/commit/6032d653e91f3bbf2332e1fd3eb1d87d11cd4d08), [`d87ad83`](https://github.com/forinda/kick-js/commit/d87ad839b60791f5a8bec9a56c90d948b99053f8), [`9bb9620`](https://github.com/forinda/kick-js/commit/9bb96203c5d5db06163ea76fe42daa67de861ebd), [`2e36473`](https://github.com/forinda/kick-js/commit/2e36473830435208ab6c383753a56b1d1fbf2d12)]:
...
- Updated dependencies [[`37ce0d0`](https://github.com/forinda/kick-js/commit/37ce0d00d97838d7f0c0cb2266505e308cf84a26), [`4a3755d`](https://github.com/forinda/kick-js/commit/4a3755d0d4946e4818a33859d1e1918babbfce0e)]:
  - @forinda/kickjs@8.5.0
  - @forinda/kickjs-db@7.3.0
