...
import { HEALTH_REPOSITORY } from './domain/repositories/health.repository'
...
export class HealthModule implements AppModule {
  ...
  register(container: Container): void {
    container.registerFactory(HEALTH_REPOSITORY, () =>
      container.resolve(InMemoryHealthRepository),
    )
  }

  /**
   * Declare HTTP routes for this module.
   * The path is prefixed with the global apiPrefix and version (e.g. /api/v1/healths).
