 ...
 */
import { HealthId } from '../value-objects/health-id.vo'
...
export class Health {
  private constructor(private props: HealthProps) {}

  static create(params: { name: string }): Health {
    const now = new Date()
    return new Health({
      id: HealthId.create(),
      name: params.name,
  ...
  static reconstitute(props: HealthProps): Health {
