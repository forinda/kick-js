# CLAUDE.md — multi-tenant-mongoose-api Development Guide

## Project Overview

This is a **Minimal Express** application built with [KickJS](https://forinda.github.io/kick-js/) — a decorator-driven Node.js framework on Express 5 and TypeScript.
